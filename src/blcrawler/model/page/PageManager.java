...
public class PageManager
{
    ...
    public void addPartBrowse(PartBrowse partbrowse)
    {
        ...
        else
        {
            ...
            try (Writer writer = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(
                            "C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartBrowse/" + fileName),
                    "utf-8")))
            {
    ...
    public void addPartCatalog(PartCatalog partcatalog)
    {
        ...
        else
        {
            ...
            try (Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                    "C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartCatalog/" + fileName),
                    "utf-8")))
            {
     ...
     * FileReader("C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartBrowse"+input)); String line;
     * while((line = in.readLine()) != null) { txtRep=txtRep+line+System.lineSeparator(); }
     * in.close();
     * 
    ...
    public void initializePartBrowse()
    {
        ...
        partBrowseDirectory = new File(
                "C:/Users/Joseph/Documents/BLCrawler/Database/Pages/PartBrowse");
        partBrowseFiles = partBrowseDirectory.listFiles();
    ...
    public void initializePartCatalog()
    {
        ...
        partCatalogDirectory = new File(
                "C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartCatalog");
        partCatalogFiles = partCatalogDirectory.listFiles();
        ...
        for (int k = 0; k < partCatalogFiles.length; k++)
        {
            ...
            {
                txtReader = new BufferedReader(
                        new FileReader("C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartCatalog/"
    ...
    public void updatePartBrowseIndex(PartBrowseIndex index)
    {
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                "C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartBrowseIndex/partbrowseindex.txt"),
                "utf-8")))
        {
    ...
    public void updatePartCatalogIndex(PartCatalogIndex index)
    {
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(
                "C:/Users/Joe/Documents/BLCrawl/Database/Pages/PartCatalogIndex/partcatalogindex.txt"),
                "utf-8")))
        {
