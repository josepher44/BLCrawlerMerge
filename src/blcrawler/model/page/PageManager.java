...
public class PageManager
{
    ...
    public void buildPartIndex()
    {
        ...
        for (int i = 0; i < partCatalogFiles.length; i++)
        {
            ...
            try
            {
                in = new BufferedReader(new FileReader(
                        "C:/Users/Owner/Documents/BLCrawler/OldDatabase/PartCatalog/partcatalog_"
                                + fiveDigits(i + 1) + ".txt"));
                String line;
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(
                new FileOutputStream(
                        "C:/Users/Owner/Documents/BLCrawler/OldDatabase/PartIndex/partindex.txt"),
                "utf-8")))
        {
            writer.write(txtRep);
        }
    ...
    public void addPart(Part part)
    {
        ...
        else
        {
            ...
            try (Writer writer = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(
                            "C:/Users/Owner/Documents/BLCrawler/OldDatabase/Part/" + fileName),
                    "utf-8")))
            {
    ...
    public void initializePart()
    {
        ...
        partDirectory = new File("C:/Users/Owner/Documents/BLCrawler/OldDatabase/Part");
        partFiles = partDirectory.listFiles();
        ...
        for (int k = 0; k < partFiles.length; k++)
        {
            try
            {
                txtReader = new BufferedReader(
                        new FileReader("C:/Users/Owner/Documents/BLCrawler/OldDatabase/Part/"
